...
public class OrderStatusController implements Serializable {
    ...
    @EJB
    private com.shop.EJB.OrderStatusFacade ejbFacade;
    ...
    public OrderStatus getOrderStatus(java.lang.Integer id) {
    ...
    public static class OrderStatusControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getOrderStatus(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof OrderStatus) {
                ...
                return getStringKey(o.getOrderStatusId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + OrderStatus.class.getName());
            }
        }
